package p.productivity.myapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void changePos() {
        ...
        if (blackY > frameHeight) {
            blackY = -100;
            blackX = (float) Math.floor(Math.random() * (frameWidth - black.getHeight()));
        }
    ...
    public void gameOver() {
        ...
        if (score > highScore) {
            ...
            editor.putInt("High_SCOREE", highScore);
            editor.commit();
        }
